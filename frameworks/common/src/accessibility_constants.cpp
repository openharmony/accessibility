...
const std::string ACTION_ARGU_CUSTOM_ACTION = "customAction";
...
const std::string OHOS_PERMISSION_MANAGE_SECURE_SETTINGS = "ohos.permission.MANAGE_SECURE_SETTINGS";
const std::string OHOS_PERMISSION_MANAGE_SETTINGS = "ohos.permission.MANAGE_SETTINGS";
const std::string OHOS_PERMISSION_ACCESSIBILITY_EXTENSION_ABILITY = "ohos.permission.ACCESSIBILITY_EXTENSION_ABILITY";
const std::string OHOS_PERMISSION_RUNNING_LOCK = "ohos.permission.RUNNING_LOCK";
...
const int32_t PREFETCH_RECURSIVE_CHILDREN_REDUCED = 1 << 4;
...
const uint32_t STATE_INPUT_INTERCEPTOR_ENABLED = 0x00020000;
const uint32_t STATE_FLASH_REMINDER_ENABLED = 0x00040000;
const uint32_t STATE_ELDER_CARE_ENABLED = 0x00080000;
const uint32_t STATE_SELF_SENIOR_MODE_STATE_ENABLED = 0x00100000;
const uint32_t STATE_SELF_SENIOR_MODE_STATE_DISABLED = 0x00200000;
