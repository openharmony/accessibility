...
public:
    ...
    Accessibility::RetError GetCaptionsState(bool &state, bool isPermissionRequired = true);
    Accessibility::RetError GetCaptionsProperty(CaptionProperty &caption, bool isPermissionRequired = true);
