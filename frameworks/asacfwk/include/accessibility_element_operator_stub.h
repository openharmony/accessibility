...
public:
    ...
    virtual void SearchElementInfoByAccessibilityId(const long elementId, const int requestId,
        const sptr<IAccessibilityElementOperatorCallback> &callback, const int mode) override;
    ...
    virtual void ExecuteAction(const long elementId, const int action,
        ...
        int requestId, const sptr<IAccessibilityElementOperatorCallback> &callback) override;
     ...
     */
    class CallbackImpl : public AccessibilityElementOperatorCallback {
    public:
         ...
         * @return
         */
        virtual void SetExecuteActionResult(const bool succeeded, const int requestId) override;
         ...
         */
        std::map<const int, const sptr<IAccessibilityElementOperatorCallback>> GetAACallbackList();
