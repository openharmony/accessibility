...
#ifndef ACCESSIBILITY_ELEMENT_OPERATOR_INTERFACE_H
#define ACCESSIBILITY_ELEMENT_OPERATOR_INTERFACE_H
...
public:
    ...
    virtual void SearchElementInfoByAccessibilityId(const long elementId,
        const int requestId, const sptr<IAccessibilityElementOperatorCallback> &callback, const int mode) = 0;
    ...
    virtual void SearchElementInfosByText(const long elementId, const std::string &text,
        const int requestId, const sptr<IAccessibilityElementOperatorCallback> &callback) = 0;
