...
public:
    ...
    MOCK_METHOD4(
        SearchElementInfoByAccessibilityId, void(const int32_t elementId, const int32_t requestId,
                                                 AccessibilityElementOperatorCallback& callback, const int32_t mode));
    MOCK_METHOD4(SearchElementInfosByText, void(const int32_t elementId, const std::string& text, const int32_t requestId,
