...
public:
    ...
    AccessibilityInteractionOperationStub::CallbackImpl callback_;
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_001, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::SEARCH_BY_ACCESSIBILITY_ID), data, reply, option);
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_002, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::SEARCH_BY_TEXT), data, reply, option);
    EXPECT_EQ(res, OHOS::Accessibility::ERR_INVALID_STATE);
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_003, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::FIND_FOCUSED_INFO), data, reply, option);
    EXPECT_EQ(res, OHOS::Accessibility::ERR_INVALID_STATE);
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_004, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::FOCUS_FIND), data, reply, option);
    EXPECT_EQ(res, OHOS::Accessibility::ERR_INVALID_STATE);
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_005, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::PERFORM_ACTION), data, reply, option);
    EXPECT_EQ(res, OHOS::Accessibility::ERR_INVALID_STATE);
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_006, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::CLEAR_FOCUS), data, reply, option);
    EXPECT_EQ(res, OHOS::Accessibility::ERR_INVALID_STATE);
...
HWTEST_F(AccessibilityInteractionStubUnitTest, OnRemoteRequest_007, TestSize.Level1)
{
    ...
    int res = mockStub_->OnRemoteRequest(static_cast<uint32_t>(IAccessibilityInteractionOperation::Message::OUTSIDE_TOUCH), data, reply, option);
    EXPECT_EQ(res, OHOS::Accessibility::ERR_INVALID_STATE);
 ...
 */
HWTEST_F(AccessibilityInteractionStubUnitTest, PerformAction_001, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "PerformAction_001 start";

    std::map<std::string, std::string> actionArguments;
    mockStub_->PerformAction(1, 1, actionArguments, 1, nullptr);
 ...
 * @tc.desc: Test function SetPerformActionResult
 */
HWTEST_F(AccessibilityInteractionStubUnitTest, SetPerformActionResult_001, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "SetPerformActionResult_001 start";

    callback_.SetPerformActionResult(true, 1);
