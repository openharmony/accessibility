...
public:
    ...
    sptr<AccessibilityInteractionOperationCallbackProxy> mockProxy_ = nullptr;
    ...
    void SetUp() {
        ...
        mockProxy_ = new AccessibilityInteractionOperationCallbackProxy(mockStub_);
 ...
 */
HWTEST_F(AccessibilityInteractionProxyCallbackUnitTest, SetSearchElementInfoByAccessibilityIdResult_001, TestSize.Level1)
{
 ...
 */
HWTEST_F(AccessibilityInteractionProxyCallbackUnitTest, SetPerformActionResult_001, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "SetPerformActionResult_001 start";
    mockProxy_->SetPerformActionResult(true, 1);
