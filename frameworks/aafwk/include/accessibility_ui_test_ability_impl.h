...
public:
     ...
     * @return Return RET_OK if registers listener successfully, otherwise is not.
     */
     ...
     * @return Return RET_OK if the command of disconnect is sent successfully, otherwise is not.
     */
