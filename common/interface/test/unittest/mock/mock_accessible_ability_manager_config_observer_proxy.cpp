...
AccessibleAbilityManagerConfigObserverProxyMock::AccessibleAbilityManagerConfigObserverProxyMock(
...
bool AccessibleAbilityManagerConfigObserverProxyMock::WriteInterfaceToken(MessageParcel &data)
{
    HILOG_DEBUG();
    if (!data.WriteInterfaceToken(AccessibleAbilityManagerConfigObserverProxyMock::GetDescriptor())) {
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnConfigStateChanged(const uint32_t stateType)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnAudioBalanceChanged(const float audioBalance)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnBrightnessDiscountChanged(const float brightnessDiscount)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnContentTimeoutChanged(const uint32_t contentTimeout)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnDaltonizationColorFilterChanged(const uint32_t filterType)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnMouseAutoClickChanged(const int32_t mouseAutoClick)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnShortkeyTargetChanged(const std::string &shortkeyTarget)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnShortkeyMultiTargetChanged(
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnClickResponseTimeChanged(const uint32_t clickResponseTime)
{
    HILOG_DEBUG();
...
void AccessibleAbilityManagerConfigObserverProxyMock::OnIgnoreRepeatClickTimeChanged(const uint32_t ignoreRepeatClickTime)
{
    HILOG_DEBUG();
