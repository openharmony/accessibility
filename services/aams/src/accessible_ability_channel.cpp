    ...
    const int32_t mode, bool isFilter)
{
    ...
    eventHandler_->PostTask(std::bind([syncPromise, windowId, elementId, treeId, requestId,
        ...
        RetError ret = GetElementOperator(accountId, windowId, FOCUS_TYPE_INVALID, name,
