...
void MockAccessibilitySettings::RegisterSettingsHandler(const std::shared_ptr<AppExecFwk::EventHandler> &handler)
{
    HILOG_DEBUG();
    handler_ = handler;
}

void MockAccessibilitySettings::OnParameterChanged(const char *key, const char *value, void *context)
{
    ...
    MockAccessibilitySettings *settingsPtr = static_cast<MockAccessibilitySettings *>(context);
    if (!settingsPtr) {
        return;
    }
...
void MockAccessibilitySettings::RegisterParamWatcher()
{
...
RetError MockAccessibilitySettings::SetScreenMagnificationState(const bool state)
{
...
RetError MockAccessibilitySettings::SetShortKeyState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
RetError MockAccessibilitySettings::SetMouseKeyState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
...
RetError MockAccessibilitySettings::SetMouseAutoClick(const int32_t time)
{
...
RetError MockAccessibilitySettings::SetShortkeyTarget(const std::string &name)
{
...
RetError MockAccessibilitySettings::SetShortkeyMultiTarget(const std::vector<std::string> &name)
{
    HILOG_DEBUG();
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
RetError MockAccessibilitySettings::SetHighContrastTextState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
RetError MockAccessibilitySettings::SetDaltonizationState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
RetError MockAccessibilitySettings::SetInvertColorState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
RetError MockAccessibilitySettings::SetAnimationOffState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
...
RetError MockAccessibilitySettings::SetAudioMonoState(const bool state)
{
    HILOG_INFO("state = [%{public}s]", state ? "True" : "False");
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
RetError MockAccessibilitySettings::SetDaltonizationColorFilter(const uint32_t filter)
{
...
RetError MockAccessibilitySettings::SetContentTimeout(const uint32_t time)
{
...
RetError MockAccessibilitySettings::SetBrightnessDiscount(const float discount)
{
...
RetError MockAccessibilitySettings::SetAudioBalance(const float balance)
{
...
RetError MockAccessibilitySettings::SetClickResponseTime(const uint32_t time)
{
...
RetError MockAccessibilitySettings::SetIgnoreRepeatClickState(const bool state)
{
...
RetError MockAccessibilitySettings::SetIgnoreRepeatClickTime(const uint32_t time)
{
    HILOG_INFO("click response time = [%{public}u]", time);
#ifdef OHOS_BUILD_ENABLE_HITRACE
...
void MockAccessibilitySettings::UpdateSettingsInAtoHosStatePart(ConfigValueAtoHosUpdate &atoHosValue)
{
    sptr<AccessibilityAccountData> accountData =
        Singleton<AccessibleAbilityManagerService>::GetInstance().GetCurrentAccountData();
    if (!accountData) {
...
void MockAccessibilitySettings::UpdateSettingsInAtoHos()
{
    sptr<AccessibilityAccountData> accountData =
        Singleton<AccessibleAbilityManagerService>::GetInstance().GetCurrentAccountData();
    if (!accountData) {
...
RetError MockAccessibilitySettings::GetScreenMagnificationState(bool &state)
{
    HILOG_DEBUG();
    if (!handler_) {
        HILOG_ERROR("handler_ is nullptr.");
...
RetError MockAccessibilitySettings::GetShortKeyState(bool &state)
{
    HILOG_DEBUG();
    if (!handler_) {
        HILOG_ERROR("handler_ is nullptr.");
...
RetError MockAccessibilitySettings::GetMouseKeyState(bool &state)
{
    HILOG_DEBUG();
    if (!handler_) {
        HILOG_ERROR("handler_ is nullptr.");
...
RetError MockAccessibilitySettings::GetMouseAutoClick(int32_t &time)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetShortkeyTarget(std::string &name)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetShortkeyMultiTarget(std::vector<std::string> &name)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetHighContrastTextState(bool &state)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetDaltonizationState(bool &state)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetInvertColorState(bool &state)
{
    HILOG_DEBUG();
...
RetError MockAccessibilitySettings::GetAnimationOffState(bool &state)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetAudioMonoState(bool &state)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetDaltonizationColorFilter(uint32_t &type)
{
    HILOG_DEBUG();
...
RetError MockAccessibilitySettings::GetContentTimeout(uint32_t &timer)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetBrightnessDiscount(float &brightness)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetAudioBalance(float &balance)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetClickResponseTime(uint32_t &time)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetIgnoreRepeatClickState(bool &state)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
RetError MockAccessibilitySettings::GetIgnoreRepeatClickTime(uint32_t &time)
{
    HILOG_DEBUG();
    auto syncPromise = std::make_shared<ffrt::promise<RetError>>();
    if (syncPromise == nullptr) {
...
void MockAccessibilitySettings::UpdateConfigState()
{
...
void MockAccessibilitySettings::UpdateAudioBalance()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateBrightnessDiscount()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateContentTimeout()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateDaltonizationColorFilter()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateMouseAutoClick()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateShortkeyTarget()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateShortkeyMultiTarget()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateClickResponseTime()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateIgnoreRepeatClickTime()
{
    handler_->PostTask([this]() {
...
RetError MockAccessibilitySettings::GetCaptionProperty(AccessibilityConfig::CaptionProperty &caption)
{
    HILOG_DEBUG();
    if (!handler_) {
        HILOG_ERROR("handler_ is nullptr.");
...
RetError MockAccessibilitySettings::SetCaptionProperty(const AccessibilityConfig::CaptionProperty &caption)
{
    HILOG_DEBUG();
    if (!handler_) {
        HILOG_ERROR("handler_ is nullptr.");
...
RetError MockAccessibilitySettings::SetCaptionState(const bool state)
{
    HILOG_DEBUG();
    sptr<AccessibilityAccountData> accountData =
        Singleton<AccessibleAbilityManagerService>::GetInstance().GetCurrentAccountData();
...
RetError MockAccessibilitySettings::GetCaptionState(bool &state)
{
    HILOG_DEBUG();
    if (!handler_) {
        HILOG_ERROR("handler_ is nullptr.");
...
void MockAccessibilitySettings::UpdateCaptionProperty()
{
    handler_->PostTask([this]() {
...
void MockAccessibilitySettings::UpdateAllSetting()
{
    HILOG_DEBUG();
    if (!handler_) {
