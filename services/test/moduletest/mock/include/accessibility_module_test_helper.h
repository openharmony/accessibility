...
#ifndef ACCESSIBILITY_MODULE_TEST_HELPER_H
#define ACCESSIBILITY_MODULE_TEST_HELPER_H
...
class AccessibilityAbilityMtHelper {
public:
    static AccessibilityAbilityMtHelper& GetInstance()
    {
        static AccessibilityAbilityMtHelper helper;
        return helper;
    }
...
#endif // ACCESSIBILITY_MODULE_TEST_HELPER_H