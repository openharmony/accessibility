...
#ifndef MOCK_MT_ACCESSIBILITY_GESTURE_RECOGNIZER_H
#define MOCK_MT_ACCESSIBILITY_GESTURE_RECOGNIZER_H
...
class MockMtGestureHandler : public GestureHandler {
public:
    MockMtGestureHandler(const std::shared_ptr<AppExecFwk::EventRunner>& runner, AccessibilityGestureRecognizer& server);
    virtual ~MockMtGestureHandler() = default;
...
#endif // MOCK_MT_ACCESSIBILITY_GESTURE_RECOGNIZER_H