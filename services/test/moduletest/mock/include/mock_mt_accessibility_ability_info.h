...
#ifndef MOCK_MT_ACCESSIBILITY_ABILITY_INFO_H
#define MOCK_MT_ACCESSIBILITY_ABILITY_INFO_H
...
class MockMtAccessibilityAbilityInfo : public AccessibilityAbilityInfo {
public:
    MockMtAccessibilityAbilityInfo() = default;
    ~MockMtAccessibilityAbilityInfo() = default;
    MockMtAccessibilityAbilityInfo(const AppExecFwk::ExtensionAbilityInfo& abilityInfo)
    {}
...
#endif // MOCK_MT_ACCESSIBILITY_ABILITY_INFO_H