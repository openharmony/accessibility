...
#ifndef MOCK_MT_ACCESSIBILITY_ELEMENT_OPERATOR_STUB_H
#define MOCK_MT_ACCESSIBILITY_ELEMENT_OPERATOR_STUB_H
...
class MockMtAccessibilityElementOperatorStub : public AccessibilityElementOperatorStub {
public:
    MockMtAccessibilityElementOperatorStub() = default;
    virtual ~MockMtAccessibilityElementOperatorStub() = default;
...
#endif // MOCK_MT_ACCESSIBILITY_ELEMENT_OPERATOR_STUB_H