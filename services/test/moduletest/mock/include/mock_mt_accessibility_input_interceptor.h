...
#ifndef MOCK_MT_ACCESSIBILITY_INPUT_INTERCEPTOR_H
#define MOCK_MT_ACCESSIBILITY_INPUT_INTERCEPTOR_H
...
class MockMtAccessibilityInputEventConsumer : public AccessibilityInputEventConsumer {
public:
    MockMtAccessibilityInputEventConsumer();
    ~MockMtAccessibilityInputEventConsumer();
...
#endif // MOCK_MT_ACCESSIBILITY_INPUT_INTERCEPTOR_H