...
#ifndef MOCK_MT_ACCESSIBILITY_ACCOUNT_DATA_H
#define MOCK_MT_ACCESSIBILITY_ACCOUNT_DATA_H
...
class MockMtAccessibilityAccountData : public RefBase {
public:
    MockMtAccessibilityAccountData(int32_t accountId);
    ~MockMtAccessibilityAccountData();
...
#endif // MOCK_MT_ACCESSIBILITY_ACCOUNT_DATA_H