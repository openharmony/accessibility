...
HWTEST_F(AamsInjectorTest, TouchEventInjector_ModuleTest_TouchEventInjector_002, TestSize.Level1)
{
    ...
    EXPECT_TRUE(!ret);
    EXPECT_EQ(MMI::PointerEvent::BUTTON_NONE, MMI::MockInputManager::GetTouchActionOfTargetIndex(0));
...
HWTEST_F(AamsInjectorTest, TouchEventInjector_ModuleTest_TouchEventInjector_003, TestSize.Level1)
{
    ...
    EXPECT_TRUE(!ret);
    EXPECT_EQ(MMI::PointerEvent::BUTTON_NONE, MMI::MockInputManager::GetTouchActionOfTargetIndex(0));
    EXPECT_EQ(MMI::PointerEvent::BUTTON_NONE, MMI::MockInputManager::GetTouchActionOfTargetIndex(1));
