...
/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_001
 * @tc.name: ExecuteAction with INJECT_ACTION_TYPE_CLICK
 * @tc.desc: Test HandleInjectAction with click action type.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest, AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_001,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_001 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "click"));
    Rect rect {100, 100, 200, 200};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 1, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_OK);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_001 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_002
 * @tc.name: ExecuteAction with INJECT_ACTION_TYPE_CLICK (numeric)
 * @tc.desc: Test HandleInjectAction with click action type using numeric value.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest, AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_002,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_002 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "1"));
    Rect rect {150, 150, 250, 250};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 2, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_OK);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Click_002 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_001
 * @tc.name: ExecuteAction with INJECT_ACTION_TYPE_DOUBLE_CLICK
 * @tc.desc: Test HandleInjectAction with double click action type.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest,
    AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_001,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_001 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "doubleClick"));
    Rect rect {200, 200, 300, 300};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 3, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_OK);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_001 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_002
 * @tc.name: ExecuteAction with INJECT_ACTION_TYPE_DOUBLE_CLICK (numeric)
 * @tc.desc: Test HandleInjectAction with double click action type using numeric value.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest,
    AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_002,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_002 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "2"));
    Rect rect {250, 250, 350, 350};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 4, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_OK);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_DoubleClick_002 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_001
 * @tc.name: ExecuteAction with INJECT_ACTION_TYPE_LONG_CLICK
 * @tc.desc: Test HandleInjectAction with long click action type.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest, AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_001,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_001 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "longClick"));
    Rect rect {300, 300, 400, 400};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 5, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_OK);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_001 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_002
 * @tc.name: ExecuteAction with INJECT_ACTION_TYPE_LONG_CLICK (numeric)
 * @tc.desc: Test HandleInjectAction with long click action type using numeric value.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest, AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_002,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_002 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "3"));
    Rect rect {350, 350, 450, 450};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 6, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_OK);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_LongClick_002 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Invalid_001
 * @tc.name: ExecuteAction with invalid inject action type
 * @tc.desc: Test HandleInjectAction with invalid action type.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest, AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Invalid_001,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Invalid_001 start";
    ...
    std::map<std::string, std::string> actionArguments;
    actionArguments.insert(std::make_pair("injectActionType", "invalidAction"));
    Rect rect {400, 400, 500, 500};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 7, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_ERR_INVALID_PARAM);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_Invalid_001 end";
}

/**
 * @tc.number: AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_MissingParam_001
 * @tc.name: ExecuteAction with missing injectActionType parameter
 * @tc.desc: Test HandleInjectAction when injectActionType is not provided.
 */
HWTEST_F(AamsAccessibleAbilityChannelTest,
    AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_MissingParam_001,
    TestSize.Level1)
{
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_MissingParam_001 start";
    ...
    std::map<std::string, std::string> actionArguments;
    // Missing injectActionType parameter
    Rect rect {450, 450, 550, 550};

    RetError result = AccessibilityHelper::GetInstance().GetTestStub()->ExecuteAction(
        0, 8, AccessibilityAction::INJECT_ACTION, actionArguments, 0, nullptr, rect);
    sleep(1);

    GTEST_LOG_(INFO) << "Test result";
    EXPECT_EQ(result, RET_ERR_INVALID_PARAM);
    GTEST_LOG_(INFO) << "AccessibleAbilityChannel_ModuleTest_ExecuteAction_InjectAction_MissingParam_001 end";
}
} // namespace Accessibility
} // namespace OHOS