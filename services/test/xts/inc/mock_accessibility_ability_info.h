...
#include "a11y_ability_info.h"

namespace OHOS {
namespace A11y {
class MockA11yAbilityInfo : public A11yAbilityInfo {
public:
    MockA11yAbilityInfo() = default;
    ~MockA11yAbilityInfo() = default;
    MockA11yAbilityInfo(const AppExecFwk::ExtensionAbilityInfo& abilityInfo)
    {}
    MOCK_METHOD0(GetA11yAbilityType, uint32_t());
    ...
    MOCK_METHOD1(Unmarshalling, A11yAbilityInfo*(Parcel& parcel));
    inline void SetCapabilityValues(uint32_t capabilities)
    {}

    inline void SetA11yAbilityType(uint32_t abilityTypes)
    {}
