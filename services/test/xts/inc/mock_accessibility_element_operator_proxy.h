...
namespace OHOS {
namespace A11y {
class MockA11yElementOperatorProxy : public A11yElementOperatorProxy {
public:
    MockA11yElementOperatorProxy(const sptr<IRemoteObject>& object) : A11yElementOperatorProxy(object)
    {}
    virtual ~MockA11yElementOperatorProxy() override
    {}
    MOCK_METHOD5(SearchElementInfoByA11yId,
        void(const int64_t elementId, const int32_t requestId,
            const sptr<IA11yElementOperatorCallback>& callback, const int32_t mode, bool isFilter));
    MOCK_METHOD4(
        SearchElementInfosByText, void(const int64_t elementId, const std::string& text, const int32_t requestId,
                                      const sptr<IA11yElementOperatorCallback>& callback));
    ...
    MOCK_METHOD5(ExecuteAction, void(const int64_t elementId, const int32_t action,
        ...
        int32_t requestId, const sptr<IA11yElementOperatorCallback>& callback));
