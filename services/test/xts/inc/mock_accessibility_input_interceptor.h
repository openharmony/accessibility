...
namespace OHOS {
namespace A11y {
class MockA11yInputEventConsumer : public A11yInputEventConsumer {
public:
    MockA11yInputEventConsumer();
    ~MockA11yInputEventConsumer();
...
class MockA11yInputInterceptor : public A11yInputInterceptor {
public:
    MOCK_METHOD0(GetInstance, sptr<A11yInputInterceptor>());
