...
namespace OHOS {
namespace A11y {
class MockA11yElementOperatorStub : public A11yElementOperatorStub {
public:
    MockA11yElementOperatorStub() = default;
    virtual ~MockA11yElementOperatorStub() = default;
    ...
    MOCK_METHOD5(ExecuteAction,
        void(const int64_t elementId, const int32_t action, const std::map<std::string, std::string> &actionArguments,
            const int32_t requestId, const sptr<IA11yElementOperatorCallback>& callback));
