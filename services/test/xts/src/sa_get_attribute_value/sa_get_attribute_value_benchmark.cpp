...
TGEventHandler::TGEventHandler(
    const std::shared_ptr<AppExecFwk::EventRunner> &runner, GetAttributeValueTest &tgServer)
    : AppExecFwk::EventHandler(runner), tgServer_(tgServer)
{
}

int64_t GetAttributeValueTest::lastDoubleTapTime = 0;

GetAttributeValueTest::GetAttributeValueTest()
{
    HILOG_DEBUG();
    currentState_ = static_cast<int32_t>(TouchGuideState::TOUCH_GUIDING);
}

void GetAttributeValueTest::StartUp()
{
    HILOG_DEBUG();
...
void TGEventHandler::ProcessEvent(const AppExecFwk::InnerEvent::Pointer &event)
{
    ...
    switch (event->GetInnerEventId()) {
        case GetAttributeValueTest::EXIT_GESTURE_REC_MSG:
            tgServer_.SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_GESTURE_END);
            break;
        case GetAttributeValueTest::SEND_HOVER_ENTER_MOVE_MSG:
            HoverEnterAndMoveRunner();
            break;
        case GetAttributeValueTest::SEND_HOVER_EXIT_MSG:
            HoverExitRunner();
            break;
        case GetAttributeValueTest::SEND_TOUCH_GUIDE_END_MSG:
            tgServer_.SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_END);
            break;
        default:
            break;
    }
...
void GetAttributeValueTest::SendTouchEventToAA(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
    ...
    if (event.GetPointerAction() == MMI::PointerEvent::POINTER_ACTION_DOWN) {
        SendA11yEventToAA(EventType::TYPE_TOUCH_BEGIN);
    } else if (!pointerIterm.IsPressed()) {
        SendA11yEventToAA(EventType::TYPE_TOUCH_END);
    }
}

bool GetAttributeValueTest::OnPointerEvent(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::HandlePointerEvent(MMI::PointerEvent &event)
{
...
void GetAttributeValueTest::DestroyEvents()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::SendA11yEventToAA(EventType eventType)
{
    HILOG_DEBUG("eventType is 0x%{public}x.", eventType);

    A11yEventInfo eventInfo {};
    eventInfo.SetEventType(eventType);
    int32_t windowsId = Singleton<A11yWindowManager>::GetInstance().GetActiveWindowId();
...
void GetAttributeValueTest::SendGestureEventToAA(GestureType gestureId)
{
...
void GetAttributeValueTest::OffsetEvent(MMI::PointerEvent &event)
{
...
void GetAttributeValueTest::SendEventToMultimodal(MMI::PointerEvent &event, int32_t action)
{
...
std::list<MMI::PointerEvent> GetAttributeValueTest::getHoverEnterAndMoveEvent()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::ClearHoverEnterAndMoveEvent()
{
    HILOG_DEBUG();
...
std::shared_ptr<MMI::PointerEvent> GetAttributeValueTest::getLastReceivedEvent()
{
    HILOG_DEBUG();
...
bool GetAttributeValueTest::TouchGuideListener::OnDoubleTap(MMI::PointerEvent &event)
{
    HILOG_INFO();
    ...
    return server_.ExecuteActionOnA11yFocused(ActionType::ACCESSIBILITY_ACTION_CLICK);
}

bool GetAttributeValueTest::TouchGuideListener::OnStarted()
{
    HILOG_DEBUG();
    ...
    server_.SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_GESTURE_BEGIN);
    return true;
}

void GetAttributeValueTest::TouchGuideListener::MultiFingerGestureOnStarted(bool isTwoFingerGesture)
{
    HILOG_DEBUG();
...
bool GetAttributeValueTest::TouchGuideListener::OnCompleted(GestureType gestureId)
{
    ...
    server_.OnTouchInteractionEnd();
    server_.SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_GESTURE_END);
...
void GetAttributeValueTest::TouchGuideListener::MultiFingerGestureOnCompleted(GestureType gestureId)
{
    HILOG_INFO("gestureId is %{public}d", gestureId);
...
bool GetAttributeValueTest::TouchGuideListener::OnCancelled(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::TouchGuideListener::MultiFingerGestureOnCancelled(const bool isNoDelayFlag)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::ElementOperatorCallbackImpl::SetFindFocusedElementInfoResult(const A11yElementInfo &info,
...
void GetAttributeValueTest::ElementOperatorCallbackImpl::SetSearchElementInfoByTextResult(
...
void GetAttributeValueTest::ElementOperatorCallbackImpl::SetSearchElementInfoByA11yIdResult(
    const std::vector<A11yElementInfo> &infos, const int32_t requestId)
{
    HILOG_DEBUG("Response [requestId:%{public}d]", requestId);
    elementInfosResult_ = infos;
...
void GetAttributeValueTest::ElementOperatorCallbackImpl::SetFocusMoveSearchResult(const A11yElementInfo &info,
    const int32_t requestId)
{
    HILOG_DEBUG("Response [requestId:%{public}d]", requestId);
    a11yInfoResult_ = info;
...
void GetAttributeValueTest::ElementOperatorCallbackImpl::SetExecuteActionResult(const bool succeeded, const int32_t requestId)
{
...
void GetAttributeValueTest::HandleTouchGuidingState(MMI::PointerEvent &event)
{
...
void GetAttributeValueTest::HandleDraggingState(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::HandleTransmitingState(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::HandlePassingThroughState(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::Clear(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::Clear()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::SendExitEvents()
{
    HILOG_DEBUG();

    if (!HasEventPending(SEND_TOUCH_GUIDE_END_MSG)) {
        PostA11yEvent(SEND_TOUCH_GUIDE_END_MSG);
    }
}

void GetAttributeValueTest::HandleTouchGuidingStateInnerDown(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
    ...
    if (!gestureRecognizer_.IsfirstTap() && !multiFingerGestureRecognizer_.IsMultiFingerGestureStarted()) {
        ...
        A11yElementInfo focusedElementInfo = {};
...
void GetAttributeValueTest::SendPointerDownEventToMultimodal(MMI::PointerEvent event, int32_t action)
{
...
void GetAttributeValueTest::HandleTouchGuidingStateInnerMove(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::HandleDraggingStateInnerMove(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
    std::vector<int32_t> pIds = event.GetPointerIds();
    ...
    if (pointCount == POINTER_COUNT_1) {
        ...
        A11yDisplayManager &displayMgr = Singleton<A11yDisplayManager>::GetInstance();
...
float GetAttributeValueTest::GetAngleCos(float offsetX, float offsetY, bool isGetX)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::GetPointOffset(MMI::PointerEvent &event, std::vector<float> &firstPointOffset,
...
bool GetAttributeValueTest::IsDragGestureAccept(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
bool GetAttributeValueTest::IsRealMoveState(MMI::PointerEvent &event) const
{
...
void GetAttributeValueTest::RecordInjectedEvent(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::RecordReceivedEvent(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::ClearReceivedEventRecorder()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::ClearInjectedEventRecorder()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::SendAllDownEvents(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::SendAllUpEvents(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::SendUpForAllInjectedEvent(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::PostGestureRecognizeExit()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::PostHoverEnterAndMove(MMI::PointerEvent &event)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::PostHoverExit()
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::PostA11yEvent(uint32_t innerEventID)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::CancelPostEvent(uint32_t innerEventID)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::CancelPostEventIfNeed(uint32_t innerEventID)
{
    HILOG_DEBUG();
...
bool GetAttributeValueTest::HasEventPending(uint32_t innerEventID)
{
    HILOG_DEBUG();
...
void GetAttributeValueTest::ForceSendAndRemoveEvent(uint32_t innerEventID, MMI::PointerEvent &event)
{
    HILOG_DEBUG();
    ...
    switch (innerEventID) {
        case SEND_HOVER_ENTER_MOVE_MSG:
            SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_BEGIN);
        ...
        case SEND_TOUCH_GUIDE_END_MSG:
            SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_END);
            break;
        default:
            break;
    }
...
bool GetAttributeValueTest::IgnoreRepeatExecuteAction()
{
    HILOG_DEBUG();
...
bool GetAttributeValueTest::ExecuteActionOnA11yFocused(const ActionType &action)
{
    HILOG_DEBUG();
    if (IgnoreRepeatExecuteAction()) {
        return true;
    }
    return Singleton<AccessibleAbilityManagerService>::GetInstance().ExecuteActionOnA11yFocused(action);
}

bool GetAttributeValueTest::FindFocusedElement(A11yElementInfo &elementInfo)
{
    HILOG_DEBUG();
...
void TGEventHandler::HoverEnterAndMoveRunner()
{
    ...
    tgServer_.SendA11yEventToAA(EventType::TYPE_TOUCH_GUIDE_BEGIN);
...
void TGEventHandler::HoverExitRunner()
{
    ...
    if (!HasInnerEvent(GetAttributeValueTest::SEND_TOUCH_GUIDE_END_MSG)) {
        RemoveEvent(GetAttributeValueTest::SEND_TOUCH_GUIDE_END_MSG);
        SendEvent(GetAttributeValueTest::SEND_TOUCH_GUIDE_END_MSG, 0, EXIT_GESTURE_REC_TIMEOUT);
    }
}
} // namespace A11y
} // namespace OHOS