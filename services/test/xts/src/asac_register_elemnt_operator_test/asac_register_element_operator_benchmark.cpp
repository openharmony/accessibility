...
namespace {
    class AsacRegisterElementOperatorBenchamark : public OHOS::A11yConfig::A11yConfigObserver {
    public:
        AsacRegisterElementOperatorBenchamark() = default;
    ...
    {
        bool value = false;
        std::shared_ptr<AsacRegisterElementOperatorBenchamark> configObserver =
            std::make_shared<AsacRegisterElementOperatorBenchamark>();
