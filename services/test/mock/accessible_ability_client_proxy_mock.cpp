...
void AccessibleAbilityClientProxy::OnAccessibilityEvent(const AccessibilityEventInfo &eventInfo) {
    ...
    testWindowId = eventInfo.GetWindowId();
    testWindowChangeTypes_ = eventInfo.GetWindowChangeTypes();
...
void AccessibleAbilityClientProxy::OnKeyPressEvent(const KeyEvent &keyEvent, const int sequence) {
