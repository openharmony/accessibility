...
void AccessibleAbilityClientStubImpl::OnKeyPressEvent(const KeyEvent &keyEvent, const int sequence)
{}

void AccessibleAbilityClientStubImpl::OnKeyPressEventInner(const KeyEvent &keyEvent, const int sequence)
{}
