...
HWTEST_F(AccessibilityScreenTouchUnitTest, AccessibilityScreenTouch_Unittest_SetClickResponseTime_002, TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutShortest,
      false, AccessibilityConfig::ResponseDelayMedium);
...
HWTEST_F(AccessibilityScreenTouchUnitTest, AccessibilityScreenTouch_Unittest_SetClickResponseTime_003, TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutShortest,
      false, AccessibilityConfig::ResponseDelayLong);
    screenTouch_ = std::make_shared<AccessibilityScreenTouch>();
    ...
    TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutShortest,
      true, AccessibilityConfig::ResponseDelayShort);
    screenTouch_ = std::make_shared<AccessibilityScreenTouch>();
    ...
    TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutMedium,
      true, AccessibilityConfig::ResponseDelayShort);
    screenTouch_ = std::make_shared<AccessibilityScreenTouch>();
    ...
    TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutLongest,
      true, AccessibilityConfig::ResponseDelayShort);
    screenTouch_ = std::make_shared<AccessibilityScreenTouch>();
...
HWTEST_F(AccessibilityScreenTouchUnitTest, AccessibilityScreenTouch_Unittest_HandleBothState_001, TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutLongest,
      true, AccessibilityConfig::ResponseDelayLong);
...
HWTEST_F(AccessibilityScreenTouchUnitTest, AccessibilityScreenTouch_Unittest_HandleBothState_003, TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutMedium,
      true, AccessibilityConfig::ResponseDelayMedium);
    ...
    AccessibilityScreenTouch_Unittest_GetRealIgnoreRepeatClickTime_001, TestSize.Level1)
{
    ...
    Singleton<ExtendServiceManager>::GetInstance().SetClickConfig(AccessibilityConfig::RepeatClickTimeoutLong,
      false, AccessibilityConfig::ResponseDelayShort);
    screenTouch_ = std::make_shared<AccessibilityScreenTouch>();
