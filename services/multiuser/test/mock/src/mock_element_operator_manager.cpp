...
void MockElementOperatorManager::AddAccessibilityWindowConnection(
...
void MockElementOperatorManager::RemoveAccessibilityWindowConnection(const int32_t windowId)
{
    HILOG_INFO("windowId(%{public}d)", windowId);
    std::lock_guard lock(asacConnectionsMutex_);
...
const sptr<AccessibilityWindowConnection> MockElementOperatorManager::GetAccessibilityWindowConnection(
...
void MockElementOperatorManager::DeleteConnectionAndDeathRecipient(int32_t windowId,
...
RetError MockElementOperatorManager::VerifyingToKenId(const uint32_t tokenId, const int32_t windowId,
...
ErrCode MockElementOperatorManager::GetRootParentId(int32_t windowId, int32_t treeId, int64_t& parentId)
{
...
bool MockElementOperatorManager::GetParentElementRecursively(int32_t windowId, int64_t elementId,
...
void MockElementOperatorManager::OutsideTouch(int32_t windowId)
{
    HILOG_DEBUG();
    sptr<AccessibilityWindowConnection> connection = GetAccessibilityWindowConnection(windowId);
    if (connection && connection->GetProxy()) {
...
void MockElementOperatorManager::AddDeathRecipient(int32_t windowId,
...
void MockElementOperatorManager::AddDeathRecipient(int32_t windowId, int32_t treeId,
    const sptr<IRemoteObject::DeathRecipient>& deathRecipient)
{
    std::lock_guard lock(deathRecipientMutex_);
...
void MockElementOperatorManager::RemoveDeathRecipient(int32_t windowId)
{
    std::lock_guard lock(deathRecipientMutex_);
    auto iter = interactionOperationDeathRecipients_.find(windowId);
    if (iter != interactionOperationDeathRecipients_.end()) {
...
void MockElementOperatorManager::RemoveDeathRecipient(int32_t windowId, int32_t treeId)
{
    std::lock_guard lock(deathRecipientMutex_);
...
void MockElementOperatorManager::RemoveTreeDeathRecipient(int32_t windowId, int32_t treeId,
    const sptr<AccessibilityWindowConnection>& connection)
{
    if (connection == nullptr) {
...
const std::map<int32_t, sptr<AccessibilityWindowConnection>>& MockElementOperatorManager::GetAsacConnections() const
{
    return asacConnections_;
}

int32_t MockElementOperatorManager::GetTreeIdBySplitElementId(const int64_t elementId)
{
    return static_cast<int32_t>(static_cast<uint64_t>(elementId) >> ELEMENT_MOVE_BIT);
}

int32_t MockElementOperatorManager::GenerateRequestId()
{
...
void MockElementOperatorManager::AddRequestId(int32_t windowId, int32_t treeId, int32_t requestId,
...
ErrCode MockElementOperatorManager::RemoveRequestId(int32_t requestId)
{
    std::lock_guard lock(requestMutex_);
...
void MockElementOperatorManager::StopCallbackWait(int32_t windowId)
{
...
void MockElementOperatorManager::StopCallbackWait(int32_t windowId, int32_t treeId)
{
    std::lock_guard lock(requestMutex_);
...
RetError MockElementOperatorManager::ClearFocus(int32_t windowId)
{
    HILOG_DEBUG("windowId(%{public}d)", windowId);
...
void MockElementOperatorManager::ClearAllConnections()
{
    std::lock_guard lock(asacConnectionsMutex_);
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetSearchElementInfoByAccessibilityIdResult(
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetSearchDefaultFocusByWindowIdResult(
    const std::vector<AccessibilityElementInfo> &infos, const int32_t requestId)
{
    HILOG_DEBUG("Response [requestId:%{public}d]", requestId);
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetSearchElementInfoByTextResult(
    const std::vector<AccessibilityElementInfo> &infos, const int32_t requestId)
{
    HILOG_DEBUG("Response [requestId:%{public}d]", requestId);
    elementInfosResult_ = infos;
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetFindFocusedElementInfoResult(
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetFocusMoveSearchResult(
    const AccessibilityElementInfo &info, const int32_t requestId)
{
    HILOG_DEBUG("Response [requestId:%{public}d]", requestId);
    accessibilityInfoResult_ = info;
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetExecuteActionResult(
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetCursorPositionResult(
...
void MockElementOperatorManager::ElementOperatorCallbackImpl::SetSearchElementInfoBySpecificPropertyResult(
...
void MockElementOperatorManager::SetElementOperatorDeathRecipient(int32_t windowId, const sptr<IRemoteObject>& object,
    int32_t accountId)
{
...
void MockElementOperatorManager::SetElementOperatorDeathRecipient(int32_t windowId, int32_t treeId,
...
void MockElementOperatorManager::RemoveElementOperatorDeathRecipient(
    int32_t windowId, const sptr<IRemoteObject>& object)
{
    HILOG_DEBUG("windowId(%{public}d)", windowId);
...
void MockElementOperatorManager::ElementOperatorDeathRecipient::OnRemoteDied(const wptr<IRemoteObject> &remote)
{
