...
#include "getfocusedwindowid_fuzzer.h"
...
bool GetFocusedWindowId(const uint8_t* data, size_t size)
{
    ...
    instance->GetFocusedWindowId(windowId);
    return true;
}
} // namespace Accessibility
} // namespace OHOS
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::Accessibility::GetFocusedWindowId(data, size);
    return 0;
}