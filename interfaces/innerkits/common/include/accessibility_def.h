...
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_NULLPTR = "System abnormality. Failed to get required service or client object (null pointer).";
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_IPC_FAILED = "System abnormality. IPC communication failed.";
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_SAMGR = "System abnormality. Failed to obtain accessibility service proxy.";
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_TIMEOUT = "System abnormality. Waiting for asynchronous operation result timed out.";
...
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_NO_REGISTER = "System abnormality. The listener or observer is not registered.";
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_NO_CONNECTION = "System abnormality. Client is not connected.";
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_NO_WINDOW_CONNECTION = "System abnormality. The target application failed to connect to accessibility service.";
...
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_PERFORM_ACTION_FAILED = "System abnormality. Failed to perform action in ACE.";
inline constexpr const char* ERROR_MESSAGE_SYSTEM_ABNORMALITY_NO_INJECTOR = "System abnormality. Failed to inject gesture event.";
